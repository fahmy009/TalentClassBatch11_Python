...
if nilai_input <= 100:  # Kondisi jika nilai input antara 0 - 100 dinyatakan Celcius
    ...
    print(f"---------------------------------------------------------------")
    print(
        f"Suhu hasil konversi ke Kelvin adalah {float(celcius_ke_kelvin(nilai_input))} K"
    )
    print(f"---------------------------------------------------------------")
    print(
        f"Suhu hasil konversi ke Farenheit adalah {float(celcius_ke_farenheit(nilai_input))} F"
    )
elif (
    ...
    print(f"---------------------------------------------------------------")
    print(
        f"Suhu hasil konversi ke Celcius adalah {float(kelvin_ke_celcius(nilai_input))} C"
    )
    print(f"---------------------------------------------------------------")
    print(
        f"Suhu hasil konversi ke Farenheit adalah {float(kelvin_ke_farenheit(nilai_input))} F"
    )
    ...
    print(f"---------------------------------------------------------------")
    print(
        f"Suhu hasil konversi ke Celcius adalah {float(farenheit_ke_celcius(nilai_input))} C"
    )
    print(f"---------------------------------------------------------------")
    print(
        f"Suhu hasil konversi ke Kelvin adalah {float((farenheit_ke_kelvin(nilai_input)))} F"
    )
